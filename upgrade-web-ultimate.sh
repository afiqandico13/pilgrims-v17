#!/bin/bash
echo "🚀 Upgrading module-web to ULTIMATE (60+ plugins)..."

# Backup old module
[ -f modules/module-web/pilgrims-web.sh ] && \
  mv modules/module-web/pilgrims-web.sh modules/module-web/pilgrims-web-basic.sh

# Create ULTIMATE web module
cat > modules/module-web/pilgrims-web.sh << 'ULTIMATE_EOF'
#!/bin/bash
# ============================================================================
...
echo "✅ module-web ULTIMATE created with 60+ checks!"
